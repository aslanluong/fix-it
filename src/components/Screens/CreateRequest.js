            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.inputContainer}>
                <RNPicker
                  ...
                  searchBarPlaceHolder={"Chọn loại thiết bị..."}
                  showPickerTitle={false}
                  searchBarContainerStyle={styles.searchBarContainerStyle}
                  pickerStyle={styles.pickerStyle}
                  pickerItemTextStyle={styles.listTextViewStyle}
                  selectedLabel={this.state.selectedText}
                  placeHolderLabel={'Loại thiết bị cần sửa'}
                ...
                <RNPicker
                  ...
                  dropDownImageStyle={styles.dropDownImageStyle}
                  // dropDownImage={require("./res/ic_drop_down.png")}
                  selectedValue={(index, item) => this._selectedBrand(index, item)}
                />
                <FontText emphasis="bold" style={styles.locationText}>
                ...
                <RNPicker
                  ...
                  disablePicker={false}
                  changeAnimation={"none"}
                  searchBarPlaceHolder={"Chọn mô tả hiện trạng thiết bị..."}
                  showPickerTitle={false}
                  searchBarContainerStyle={styles.searchBarContainerStyle}
                  pickerStyle={styles.pickerStyle}
                  pickerItemTextStyle={styles.listTextViewStyle}
                  ...
                  dropDownImageStyle={styles.dropDownImageStyle}
                  // dropDownImage={require("./res/ic_drop_down.png")}
                  selectedValue={(index, item) => this._selectedDetailErr(index, item)}
                />
              </View>
            </View>
            <View style={styles.formContainer}>
